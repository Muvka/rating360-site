...
use App\Filament\Resources\Rating\EmployeeResource\Pages;
                ...
                Section::make('Информация')
                    ...
                    ->schema([
                        ...
                        Select::make('company_id')
                            ...
                            ->required(),
                        Select::make('rating_employee_division_id')
                            ->label('Отдел')
                            ->relationship('division', 'name')
                            ->searchable()
                            ->required(),
                        Select::make('rating_employee_subdivision_id')
                            ->label('Подразделение')
                        ...
                        Select::make('directions')
                            ...
                            ->label('Направления')
                            ->multiple(),
                        Select::make('rating_employee_position_id')
                            ->label('Должность')
                            ->relationship('position', 'name')
                            ->searchable()
                            ->required(),
                        Select::make('rating_employee_level_id')
